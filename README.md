...
| index  | The name of ElasticSearch index  |
| type  | The type of the ElasticSearch document   |
| endpoint  | Exact url of ElasticSearch instance (it works with AWS ES and standard ES)  |
